          ...
          <div className="text-center space-y-6 mb-16">
            ...
            <div className="max-w-2xl mx-auto space-y-6 mt-8">
              <div className="bg-card/50 backdrop-blur-sm border border-accent/20 rounded-2xl p-8 md:p-10 shadow-xl">
                <p className="text-3xl md:text-4xl font-serif text-accent mb-3">Villa La Rose</p>
                <p className="text-xl md:text-2xl text-muted-foreground mb-6">Kafr El Sheikh - under the upper bridge</p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-6 border-t border-accent/10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-lg text-foreground">March 27, 2026</span>
                  </div>
        ...
        <div className="max-w-2xl mx-auto px-4 space-y-4">
          <div className="flex justify-center">
            <img
              ...
              alt="Footer"
              className="block mx-auto max-w-md w-[85%] md:w-full h-auto"
            />
          </div>
        </div>
      </footer>
