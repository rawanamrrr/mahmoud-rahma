            ...
            <div className="relative z-10 text-center space-y-12">
              ...
              >
                ...
                >
                  ...
                  <span className="block">Rahma</span>
                </motion.h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">March 27, 2026</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">Villa La Rose - Kafr El Sheikh - under the upper bridge</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-medium text-foreground">March 27, 2026</span>
                      </div>
                      ...
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-medium text-foreground">5:00 PM</span>
                      </div>
                    </motion.div>
                  </div>
                </div>
