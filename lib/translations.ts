...
export const translations: Translations = {
  ...
  location: {
    en: 'Villa La Rose, Kafr El Sheikh - under the upper bridge',
    ar: 'فيلا لا روز، كفر الشيخ - اسفل الكوبري العلوي',
  },
  rsvpTitle: {
    en: 'Will You Join Us?',
    ar: 'هل ستنضم إلينا؟',
  ...
  timelineStart: {
    en: '5:00 PM - 7:00 PM: Welcome & Start',
    ar: '٥:٠٠ م - ٧:٠٠ م: البداية والاستقبال',
  },
  timelineDinner: {
    en: '7:00 PM - 8:00 PM: Dinner Time',
    ar: '٧:٠٠ م - ٨:٠٠ م: وقت العشاء',
  },
  timelineSecondHalf: {
    en: '8:00 PM - 10:00 PM: The Second Part of the Wedding',
    ar: '٨:٠٠ م - ١٠:٠٠ م: النص الثاني من الفرح',
  },
  timelinePhotos: {
    en: '10:00 PM - 11:00 PM: Photos & Sky Lanterns',
    ar: '١٠:٠٠ م - ١١:٠٠ م: صور تذكارية وإطلاق فوانيس السماء',
  },
  writeUsMessage: {
  ...
  footerMessage: {
    en: "It was always you ♥️",
    ar: 'لطالما كنتِ أنتِ ♥️'
  },
  sendingMessage: {
